...
module.exports = (nsp) => {
  ...
  let matchIndividual = U1 => {
    ...
    for (let i = 0; i < cleanQue.length; i++) { // check if any users are matches
      ...
      // if U1's gender matches U2's interest or U2 is interested in anything
      // and U2's gender matches U1's interests or U1 is interested in anything
      if ((U1gender == U2interests || U2interests == 2) && (U2gender == U1interests || U1interests == 2)) {
